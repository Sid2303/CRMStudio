	...
	return (
		<div className="get-crm">
			<div className="get-crm-left">
				...
				<p>
					A CRM can help your small business grow faster. Figuring out the best CRM for small
					businesses can be tricky, read on to discover what a CRM can help your business do, which
					features are most important for each department, and how you can make the most of this
