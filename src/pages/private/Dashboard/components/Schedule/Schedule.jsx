...
import AppointmentComponent from '../../../../../components/PrivateComponents/reusables/Appointment/AppointmentComponent.jsx';
...
export default function Schedule(props) {
	...
	useEffect(() => {
		...
		const isoDate = `${year}-${String(month + 1).padStart(2, '0')}-${String(selectedDate).padStart(
			2,
			'0'
		)}`;
